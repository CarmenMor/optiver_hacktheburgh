...
Look at your positions here: http://35.179.28.10:5006/optitrade
...
You can also look at your official PnL here: http://35.179.28.10:5006/optitrade
...
**Important**: Send ```TYPE=SUBSCRIPTION_REQUEST``` to ```ip: 35.179.28.10, port: 7001``` as the very first message in order to subscribe to the data feed.
