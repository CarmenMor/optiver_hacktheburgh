...
Look at your positions here: http://36.179.45.135:5006/optitrade
...
You can also look at your official PnL here: http://36.179.45.135:5006/optitrade
...
**Important**: Send ```TYPE=SUBSCRIPTION_REQUEST``` to ```ip: 36.179.45.135, port: 7001``` as the very first message in order to subscribe to the data feed.
